Nonterminals
  ...
  add_op_eol mult_op_eol exp_op_eol hat_op_eol two_op_eol pipe_op_eol stab_op_eol
...
Terminals
  ...
  type_op dual_op add_op mult_op exp_op hat_op two_op pipe_op stab_op when_op assoc_op
  capture_op rel_op
